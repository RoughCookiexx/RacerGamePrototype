package  
{
	...
	{	
		...
		public static const LEVEL_STRING = "____________________________________________________'______________.______________'______________.______________'______________.____________.____________'____________'______________=_____________.______________'___________=_____________=____________=_____________'__________.__________'_______|"
+"______________________________________________________________________________________<````````````````____________=____________<````````````````____________=____________=____________<``````````````````_____'__________.__________'__________<```````````````````______'______.______'______.______'______._______<``````````````````____________=____________=__________!_________|"
...
+"________________<````````````````````````````___<````````````````````````````___<````````````````````````````________________________________=________________=________________/``````````````````````````________________!________________!____________>``````````````````````````________________x________________x__________o____________________________x____________________________<`````````____`````````____`````````____`````````____`````````____`````````____________________w___|"
+"________'____.____'____.____'____.____'____.____'____.____'____.____'____.____'____.____'____.____'____.__________=__________=__________=__________|"
+"__________;"
		...
		override public function update():void
		{
			...
			if (!_dead)
			{
				...
				else
				{
					...
					FlxG.overlap(_level.checkpoints, _racer, nextLevel);
